...
import './App.css';
import JapData from '../../data/jap600';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startId: 561, // start of our vocab list
      endId: 580, // end of our vocab list
    }
  ...
  componentDidMount() { // create a clone of japData and store it to our state
    this.setState((prevState) => { // proper way to increment
      ...
      return {vocabList: JapData.slice(prevState.startId-501, prevState.endId-500)}
    });
  }
