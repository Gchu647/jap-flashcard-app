...
import './App.css';
import JapData from '../../data/jap1600';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startId: 1581, // start of our vocab list
      endId: 1600, // end of our vocab list
    }
  ...
  componentDidMount() { // create a clone of japData and store it to our state
    this.setState((prevState) => { // proper way to increment
      ...
      return {vocabList: JapData.slice(prevState.startId-1501, prevState.endId-1500)}
    });
  }
