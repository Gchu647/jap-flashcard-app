...
import './App.css';
import JapData from '../../data/jap2000';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startId: 1941, // start of our vocab list
      endId: 1960, // end of our vocab list
    }
  ...
  componentDidMount() { // create a clone of japData and store it to our state
    this.setState((prevState) => { // proper way to increment
      ...
      return {vocabList: JapData.slice(prevState.startId-1901, prevState.endId-1900)}
    });
  }
