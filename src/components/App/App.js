...
import './App.css';
import JapData from '../../data/jap500';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startId: 441, // start of our vocab list
      endId: 460, // end of our vocab list
    }
  ...
  componentDidMount() { // create a clone of japData and store it to our state
    this.setState((prevState) => { // proper way to increment
      ...
      return {vocabList: JapData.slice(prevState.startId-401, prevState.endId-400)}
    });
  }
