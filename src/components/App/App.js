...
import './App.css';
import JapData from '../../data/jap700';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startId: 661, // start of our vocab list
      endId: 670, // end of our vocab list
    }
  ...
  componentDidMount() { // create a clone of japData and store it to our state
    this.setState((prevState) => { // proper way to increment
      ...
      return {vocabList: JapData.slice(prevState.startId-601, prevState.endId-600)}
    });
  }
