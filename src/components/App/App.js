...
import './App.css';
import JapData from '../../data/jap1000';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startId: 981, // start of our vocab list
      endId: 1000, // end of our vocab list
    }
  ...
  componentDidMount() { // create a clone of japData and store it to our state
    this.setState((prevState) => { // proper way to increment
      ...
      return {vocabList: JapData.slice(prevState.startId-901, prevState.endId-900)}
    });
  }
