...
import './App.css';
import JapData from '../../data/jap1200';
...
class App extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      startId: 1121, // start of our vocab list
      endId: 1140, // end of our vocab list
    }
  ...
  componentDidMount() { // create a clone of japData and store it to our state
    this.setState((prevState) => { // proper way to increment
      ...
      return {vocabList: JapData.slice(prevState.startId-1101, prevState.endId-1100)}
    });
  }
